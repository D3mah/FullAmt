<?php
 /*
 Template Name: Страница без колонок (Стандартный)
					...
					<div class="post-l">
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							<?php if (get_the_post_thumbnail()) { ?>
								...
								<?php } else { ?>
									<div class="bg-color">
										<div class="uk-background-fixed uk-background-cover uk-background-center-center uk-height-medium uk-panel uk-flex uk-flex-center uk-flex-middle" style="background-image: url('/wp-content/themes/amt/assets/img/no_photo.png');">
											<p><?php the_title(); ?></p>
											<div class="uk-card-badge-post-date uk-label" uk-tooltip="title: Дата поста; pos: top" title="" aria-expanded="false"><?php echo get_the_date(); ?></div>
											<div class="uk-card-badge-post-views uk-label" uk-tooltip="title: Просмотров; pos: top"><i class="fas fa-eye"> </i><?php the_views(); ?></div>
										</div>
